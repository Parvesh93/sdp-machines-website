...
export function SitePreloader() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-[2] opacity-25 [background-image:linear-gradient(rgba(255,255,255,0.04)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.04)_1px,transparent_1px)] [background-size:64px_64px]" />
